...
void parseActiveCourseResponse(String response) {
    ...
    if (doc.containsKey("active_course") && doc["active_course"] == true) {
        ...
        Serial.println("⚠️ No active course session found");
    }
}
...
<body>
        ...
        <div id="attendanceForm" class="form-container" style="display: none;">
            ...
            <form id="attendanceFormElement">
                <div class="form-group">
                    ...
                    <input type="text" id="matricNumber" class="form-input" placeholder="Enter your matric number" required>
                </div>
    ...
    <script>
                ...
                if (data.has_active_session) {
                    courseInfoDiv.innerHTML = `
                        <div class="course-info">
                            ...
                            <button class="refresh-btn" onclick="loadActiveCourse()">🔄 Refresh Course Info</button>
                        </div>
                    `;
                    ...
                    courseInfoDiv.innerHTML = `
                        <div class="no-course">
                            <h3>⚠️ No Active Course Session</h3>
                            <p>There is currently no active course session for attendance marking.</p>
                            <p>Please wait for a lecturer to start a session.</p>
                            <button class="refresh-btn" onclick="loadActiveCourse()">🔄 Refresh</button>
                        </div>
                    `;
        ...
        document.getElementById('attendanceFormElement').addEventListener('submit', async function(e) {
            e.preventDefault();
